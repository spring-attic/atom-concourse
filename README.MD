...
The Concourse CI editor automatically activates when the name of the file you are editing is `pipeline.yml` or `task.yml`, or editor grammar is set to `Concourse-CI-YAML`
